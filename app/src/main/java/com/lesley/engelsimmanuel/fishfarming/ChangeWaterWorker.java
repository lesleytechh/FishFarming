...
public class ChangeWaterWorker extends Worker {
    ...
    public Result doWork() {
        necessaryEvil.showNotification(context, R.drawable.alarm, constants.REMINDER_ALERT_CHANNEL_ID, constants.REMINDER_ALERT_CHANNEL_NAME, constants.REMINDER_ALERT_CHANNEL_DESCRIPTION, constants.REMINDER_CHANGE_WATER_ALERT_NOTIFICATION_TITLE, String.format(constants.REMINDER_CHANGE_WATER_ALERT_NOTIFICATION_BODY, getInputData().getString("stock_name")), constants.REMINDER_ALERT_NOTIFICATION_GROUP_KEY, constants.REMINDER_ALERT_NOTIFICATION_ID);
